...
LD_LIBRARY_PATH=${ROUTER_HOME}/lib/${PLATFORM}
...
if [[ "$DEBUG" = "1" ]]; then
	RS_CONFIG_FILE=simple-test-RS-dds-dnp3.xml
	SIMPLE=0
else
	if [[ "$SIMPLE" = "1" ]]; then
...
RTIDDSSPY_CMD=${NDDSHOME}/bin/rtiddsspy
...
#TAB3_CMD="${DNP3_HOME}/TestSetRun/dnp3testset"
...
TAB5_CMD="${DNP3_HOME}/TestSetRun/dnp3testset"
